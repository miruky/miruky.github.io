...
### 学習ダッシュボード (`/dashboard/`)
- Writing / Reading / Architect / English / ゲームの進捗を一覧表示
- 言語別進捗バー、完了率、最終アクセス日
...
- **FPS シューティング**: Three.js + React Three Fiber による3D本格FPS

### 英語学習プラットフォーム (`/english/`)
- **単語マスター**: TOEIC頻出1000単語（650/800/950レベル別、マスター/弱点単語追跡）
- **文法ドリル**: 300問（650/800/950点レベル別 × 各100問）
- **長文読解**: 50本の英文パッセージ（3レベル別、各4〜5問付き）
- **TOEIC Part 5**: 短文穴埋め100問
- **TOEIC Part 6**: テキスト穴埋め25セット
- **TOEIC Part 7**: 読解問題20セット（シングル/ダブル/トリプルパッセージ）
- **学習進捗**: localStorage ベースの進捗トラッキング、連続学習ストリーク、推定TOEICスコア
- **デイリーチャレンジ**: 毎日5問のランダム出題
- **単語フラッシュカード**: スワイプ式暗記カード
...
│   ├── english/                  # 英語学習データ（単語1000・文法300・長文50・TOEIC Part5/6/7）
...
| 英語学習問題 | 単語 **1,000** + 文法 **300** + 長文 **50** + TOEIC **145** = **1,495 問** |
| ミニゲーム | **4 種類**（タイピング・ブロック・IT クイズ・FPS） |
