...
export default function LangCoursePage() {
  ...
  useEffect(() => {
    ...
    try {
      const saved = JSON.parse(
        localStorage.getItem(`program_progress_${langId}`) || '[]'
      );
      setCompleted(saved);
    } catch {
      setCompleted([]);
        ...
        <div className="space-y-2">
          {filtered.map((lesson, idx) => {
            ...
            return (
              ...
              >
                <Link href={`/program/${langId}/${lesson.id}/`}>
                  <div
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-sm font-semibold text-white group-hover:text-accent-cyan transition-colors truncate">
                        {lesson.title}
                      </h3>
