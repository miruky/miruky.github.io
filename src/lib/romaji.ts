...
const COMBO_KANA: Record<string, string[]> = {
  ...
  'ふぁ': ['fa', 'hwa', 'fuxa', 'fula', 'huxa', 'hula'], 'ふぃ': ['fi', 'hwi', 'fuxi', 'fuli', 'huxi', 'huli'], 'ふぅ': ['fwu', 'fuxu', 'fulu', 'huxu', 'hulu'], 'ふぇ': ['fe', 'hwe', 'fuxe', 'fule', 'huxe', 'hule'], 'ふぉ': ['fo', 'hwo', 'fuxo', 'fulo', 'huxo', 'hulo'],
  'ふゃ': ['fya', 'fuxya', 'fulya', 'huxya', 'hulya'], 'ふゅ': ['fyu', 'fuxyu', 'fulyu', 'huxyu', 'hulyu'], 'ふょ': ['fyo', 'fuxyo', 'fulyo', 'huxyo', 'hulyo'],
